        ...
        html: `
          ...
          <head>
            <style>
              ...
              .button { background: #9b59b6; color: white; padding: 12px 30px; text-decoration: none; border-radius: 25px; display: inline-block; margin: 20px 0; }
              h2 { color: #9b59b6; }
            </style>
          </head>
          <body>
